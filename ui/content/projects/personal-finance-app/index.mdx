...
description: "Data-entry-first financial planning, the missing tool between budgeting apps and advisor software"
date: "2026-01-11"
status: "idea"
updated: "2026-09-24"
initiatives:
...
cross-device continuity, account recovery, or server-managed backups.
...
* **Cloudflare R2** is optional object storage for features that introduce files, such as uploaded statements,
  receipts, or encrypted export and backup artifacts. It is not the primary store for structured financial state
...
The proposed [financial provenance contract](/projects/personal-finance-app/adrs/000-financial-fact-and-calculation-provenance)
keeps effective time separate from recorded time and traces durable calculations back to immutable
facts, source artifacts, rate observations, tax rules, and scenario versions.
...
* Provider encryption at rest and TLS are baseline controls. Application-level encryption, key recovery, retention,
  deletion, and backup-restore policy remain explicit design work before a multi-user alpha

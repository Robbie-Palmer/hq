...
tech_stack:
  ...
  - "Cloudflare R2"
  - "OpenRouter"
repo_url: "https://github.com/Robbie-Palmer/hq/tree/main/ai-review"
status: "live"
platform_layers:
  - layer: "governance"
  ...
  - layer: "base"
    ...
    slots:
      - slot: "secrets.runtime-store"
        adopted: "2026-09-15T00:00:00Z"
        rationale: "The deployed service needs model-provider and infrastructure credentials."
      - slot: "secrets.ci-store"
        adopted: "2026-09-15T00:00:00Z"
        rationale: "Delivery workflows need a bounded route to deployment credentials."
  - layer: "backend-api"
    adopted: "2026-09-12T00:00:00Z"
    tracking: true
    decision: "agentic-code-review:032-stateful-ai-code-review"
    slots:
  ...
  - layer: "database"
    adopted: "2026-09-12T00:00:00Z"
    tracking: true
    decision: "agentic-code-review:033-duckdb-ai-review-scorecard"
    slots:
      - slot: "database.olap-engine"
        adopted: "2026-09-12T00:00:00Z"
        decision: "agentic-code-review:033-duckdb-ai-review-scorecard"
  - layer: "infrastructure"
    adopted: "2026-09-12T00:00:00Z"
    tracking: true
    rationale: "The service owns managed Cloudflare resources that need reviewable provisioning."
    slots:
      ...
      - slot: "infrastructure.state-backend"
        adopted: "2026-09-15T00:00:00Z"
        rationale: "CI deployments require protected shared infrastructure state."
  - layer: "observability"
    adopted: "2026-09-12T00:00:00Z"
    tracking: true
    rationale: "The live review service needs application-level operational signals."
    slots:
      - slot: "observability.application-telemetry"
        adopted: "2026-09-12T00:00:00Z"
        rationale: "Review requests and failures need application telemetry."
---
...
and evaluation. It rents interchangeable model inference from a competitive
market.
...
enables several projects beyond the Personal Knowledge Graph.
...
unrelated Personal Knowledge Graph runtime decisions remain outside the lineage.
...
added only where it improves the product, and the relevant Personal Knowledge Graph ADRs
...
## Managed Reviewers Used to Date

...
platform_layers:
  - layer: "governance"
    ...
    tracking: true
    rationale: "The public application uses the shared repository's publication and licensing rules."
  - layer: "base"
    adopted: "2026-09-12T00:00:00Z"
    tracking: true
    rationale: "The application uses the repository-wide development and delivery controls."
    slots:
      - slot: "secrets.runtime-store"
        adopted: "2026-09-15T00:00:00Z"
        rationale: "Authentication, database, and integration credentials need a runtime store."
      - slot: "secrets.ci-store"
        adopted: "2026-09-15T00:00:00Z"
        rationale: "Preview and production workflows need deployment credentials."
  - layer: "web-app"
    adopted: "2026-09-12T00:00:00Z"
    tracking: true
    rationale: "The product is delivered as a browser application."
    slots:
      - slot: "web-app.host"
        adopted: "2026-09-15T00:00:00Z"
        rationale: "The public application and Pull Request previews need managed hosting."
  - layer: "backend-api"
    adopted: "2026-09-12T00:00:00Z"
    tracking: true
    decision: "recipe-site:033-backend-platform-for-authenticated-features"
    slots:
  ...
  - layer: "infrastructure"
    adopted: "2026-09-12T00:00:00Z"
    tracking: true
    rationale: "The application owns managed Cloudflare and Neon resources."
    slots:
      ...
      - slot: "infrastructure.state-backend"
        adopted: "2026-09-15T00:00:00Z"
        rationale: "Preview and production provisioning require protected shared state."
  - layer: "observability"
    adopted: "2026-09-12T00:00:00Z"
    tracking: true
    decision: "recipe-site:047-posthog-logs"
    slots:
...
* **A public cooking commons** lets people publish recipes and adaptations, follow cooks, share outcomes, and
  discover what people actually cook rather than what attracts clicks or reviews.
...
of an adaptation back through its lineage. Closing that loop is the highest-priority product gap;
another isolated feature would not address it.
...
The roadmap follows dependencies and product gaps. Critical-path work is
...
Include retailer hand-off in the journey. Once the canonical shopping list
...
meaningful deviations. The resulting guidance is approximate and must never pose as clinical intake measurement. It
should improve the next plan, shop, adaptation, and meal without creating another daily logging obligation. Barcode
...
Audience controls provide necessary product hygiene. They do not define the product thesis.
...
* **Constraint-aware meal assistance** after server-backed planning, nutrition, kitchen state, and behavioural
  signals are trustworthy; use AI only to improve the explanation or plan
...
plan, and cook actions. The roadmap now makes that core system real instead of adding decorative social proof
...
document under [`designs/`](https://github.com/Robbie-Palmer/hq/tree/main/ui/content/projects/recipe-site/designs).
...
This comparison draws only from first-party documentation. "Not documented" means the
...
alone lacks. Frequency supplies one piece of evidence and must not become a universal score.
...
plan-to-cook conversion, actual versus expected effort, leftover use, and cuisines or techniques newly cooked. Prefer
them over click-through rate, viewing time, or the number of AI-powered surfaces shipped. No single metric should define
